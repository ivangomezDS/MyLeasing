    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                ModelState.AddModelError(string.Empty, "User whti this email already exist");
            }
            return View(model);
        }
        ...
        public async Task<IActionResult> Edit(EditUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _userHelpers.UpdateUserAsync(owner.User);
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            await _dataContext.SaveChangesAsync();
            await _userHelpers.DeleteUserAsync(owner.User.Email);
            return RedirectToAction(nameof(Index));
        }
        ...
        public async Task<IActionResult> DeleteProperty(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "The property can´t  be deleted  becuase it  has contracts");
