...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Juan", "Zuluaga", "ivandario_ca@hotmail.com", "350 634 2747", "Calle Luna Calle Sol", "Manager");
            var owner = await CheckUserAsync("2020", "Juan", "Zuluaga", "ivan.gomez@rfsolution.co", "350 634 2747", "Calle Luna Calle Sol", "Owner");
            var lessee = await CheckUserAsync("2020", "Juan", "Zuluaga", "ivangomez1287@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Lessee");
        ...
        {
            if (!_context.Manager.Any())
            {
                _context.Manager.Add(new Manager { User = user });
                await _context.SaveChangesAsync();
            }
        }
